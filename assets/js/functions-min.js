!function(t,e,i,n) {
	...
	function a(e,i,n) {
		...
		return function() {
			...
			.replace(/^[^\(]+?[\n$]/gm,"")
			.replace(/^\s+at\s+/gm,"")
			.replace(/^Object.<anonymous>\s*\(/gm,"{anonymous}()@"):"Unknown Stack Trace",r=t.console&&(t.console.warn||t.console.log);
	...
	function I(t,e) {
		...
		this.domHandler=function(e){h(t.options.enable,[t])&&i.handler(e)},this.init()
	}
